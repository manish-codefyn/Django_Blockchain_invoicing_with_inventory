...
urlpatterns = [
    ...
    path('invoice/update-status/', views.update_invoice_status, name='update-invoice-status'),
    # path('ajax/load-products/', views.load_products, name='ajax_load_products'),
    # path('invoice-item/delete/<uuid:pk>/', views.InvoiceItemDeleteView.as_view(), name='delete-item'),
    ...
    path('reports/export/<str:report_type>/', reports_views.export_report, name='export_report'),
        ...
        reports_views.ExportClientReportCSVView.as_view(),
